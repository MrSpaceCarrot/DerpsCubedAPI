...
@router.get("/categories/{id}", tags=["servers"], dependencies=[Depends(require_permission("can_view_servers"))])
...
# Get specific server
@router.get("/{id}/", tags=["servers"], dependencies=[Depends(require_permission("can_view_servers"))])
